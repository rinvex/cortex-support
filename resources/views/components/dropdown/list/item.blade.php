...
>
    @if ($icon)
        {{
            \Cortex\Support\generate_icon_html($icon, $iconAlias, (new ComponentAttributeBag([
    ...
    @if ($image)
        <div
            ...
            @if ($hasLoadingIndicator)
                wire:loading.remove.delay.{{ config('cortex.support.livewire_loading_delay', 'default') }}
    ...
    @if ($hasLoadingIndicator)
        {{
            \Cortex\Support\generate_loading_indicator_html((new ComponentAttributeBag([
    ...
    @if (filled($badge))
        ...
        @else
            <span
                ...
                @class([
                    'fi-badge',
                    ...\Cortex\Support\get_component_color_classes(BadgeComponent::class, $badgeColor),
                ])
            >
                {{ $badge }}
            </span>
