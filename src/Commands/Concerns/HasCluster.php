...
use ReflectionClass;
use Cortex\Panels\Clusters\Cluster;
    ...
    protected function askForCluster(string $initialQuestion, string $question, ?string $initialValue = null): ?string
    {
        ...
        if (empty($clusterFqns)) {
            $clusterFqn = (string) str(text(
                ...
                placeholder: 'Cortex\\Custom\\Clusters\\Blog',
                required: true,
                validate: function (string $value): ?string {
                    ...
                    return match (true) {
                        ! class_exists($value) => 'The cluster class does not exist. Please ensure you use the fully qualified class name of the cluster, such as [Cortex\\Custom\\Clusters\\Blog].',
