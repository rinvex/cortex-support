...
use Cortex\Panels\Resources\Resource;
    ...
    protected function askForResource(string $question, ?string $initialResource = null, ?string $resourcesNamespace = null): string
    {
        ...
        if (! $resourceFqns) {
            return (string) str(text(
                ...
                placeholder: 'Cortex\\Custom\\Resources\\Posts\\PostResource',
                required: true,
                validate: function (string $value): ?string {
                    ...
                    return match (true) {
                        ! class_exists($value) => 'The resource class does not exist. Please ensure you use the fully qualified class name of the resource, such as [Cortex\\Custom\\Resources\\Posts\\PostResource].',
