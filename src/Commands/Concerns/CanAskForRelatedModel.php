...
trait CanAskForRelatedModel
{
    ...
    protected function askForRelatedModel(string $relationship): ?string
    {
        ...
        return search(
            label: "Cortex couldn't automatically find the related model for the [{$relationship}] relationship. What is the fully qualified class name of the related model?",
            ...
            placeholder: 'Cortex\\Auth\\Models\\User',
        );
    }
}
